...
/* harmony import */ var _modules_modal_init_modals__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/modal/init-modals */ "./js/modules/modal/init-modals.js");
...
/* harmony import */ var _modules_swiper_swiper__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/swiper/swiper */ "./js/modules/swiper/swiper.js");
/* harmony import */ var _modules_filter_filter__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/filter/filter */ "./js/modules/filter/filter.js");
/* harmony import */ var _modules_popup_popup__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/popup/popup */ "./js/modules/popup/popup.js");
/* harmony import */ var _modules_menu_menu__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/menu/menu */ "./js/modules/menu/menu.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    Object(_modules_modal_init_modals__WEBPACK_IMPORTED_MODULE_1__["initModals"])();
    Object(_modules_accordion_accordion__WEBPACK_IMPORTED_MODULE_2__["initAccordion"])();
    Object(_modules_swiper_swiper__WEBPACK_IMPORTED_MODULE_3__["initSlider"])();
    Object(_modules_filter_filter__WEBPACK_IMPORTED_MODULE_4__["initFilter"])();
    Object(_modules_popup_popup__WEBPACK_IMPORTED_MODULE_5__["initPopup"])();
    Object(_modules_menu_menu__WEBPACK_IMPORTED_MODULE_6__["initMenu"])();
  });
}); // ---------------------------------
...
var initAccordion = function initAccordion() {
  ...
  var buttonsAccordion = accordion.querySelectorAll('[data-button]');
  var itemAccordion = accordion.querySelectorAll('[data-accordion-item]');
...
var initFilter = function initFilter() {
  if (document.querySelector('[data-accordion="filter"]')) {
    var siteBody = document.querySelector('.wrapper');
    var filter = document.querySelector('[data-accordion="filter"]');
    var buttonFilterOpen = document.querySelector('[data-open-filter]');
    var formFilter = document.querySelector('[data-form-filter]');
    var buttonFilterClose = document.querySelector('[data-close-filter]');
...
var initPopup = function initPopup() {
  ...
  var formRegistration = document.querySelector('form[data-form]');
  var modalSuccess = document.querySelector('[data-modal="success"]');
  var openPopupLinks = document.querySelectorAll('[data-open-modal]');
  var modalPopup = document.querySelector('[data-modal="login"]');
  var closePopupButton = modalPopup.querySelector('[data-close-modal]');
  var siteBody = document.querySelector('.wrapper');
  ...
  var closePopupOverlay = function closePopupOverlay(evt) {
    evt.preventDefault();
    closeModal();
  };

  var keyDownHandler = function keyDownHandler(evt) {
    var focusableElements = modalPopup.querySelectorAll(focusElements);
  ...
  var formSubmitHandler = function formSubmitHandler(evt, logIn, password) {
    evt.preventDefault();
  ...
  var openPopupHandler = function openPopupHandler(evt) {
    evt.preventDefault();
